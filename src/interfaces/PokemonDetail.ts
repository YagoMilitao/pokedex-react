...
export class Convert {
    public static toPokemonDPokemonDetail(json: string):PokemonDetail {
        return cast(JSON.parse(json), r("PokemonDPokemonDetail"));
    }

    public staticPokemonDetailToJson(value:PokemonDetail): string {
        return JSON.stringify(uncast(value, r("PokemonDPokemonDetail")), null, 2);
    }
}
